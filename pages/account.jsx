...
function account() {
  ...
  return (
    <div className="pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4">
      ...
      {/* Github btn*/}
      <button
        className="flex items-center justify-center p-3 text-white bg-gray-600 border border-gray-600 my-2"
        onClick={() => signIn()}
      >
      ...
      {/* Google btn*/}
      <button
        className="flex items-center justify-center p-3 text-white bg-blue-600 border border-blue-600 my-2"
        onClick={() => signIn()}
      >
